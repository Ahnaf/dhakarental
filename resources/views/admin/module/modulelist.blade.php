        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Module List</h1>
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1 me-5">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" data-kt-permissions-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Module" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--end::Card title-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0" id="kt_permissions_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-250px">Module Description</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($modules as $index => $module)
                                    ...
                                    <!--end::Assigned to=-->
                                    <!--begin::Created Date-->
                                    <td>{{$module->created_at->format('l, jS F, Y g:i a')}}</td>
                                    <!--end::Created Date-->
                                    <!--begin::Action=-->
                                    <td class="text-end">
                                        
                                        <!--begin::Update-->
                                        <button class="btn btn-icon btn-active-light-primary w-30px h-30px me-3 getmoduleeditid" data-modulename="{{$module->name}}" data-mdescription="{{$module->description}}" data-moduleid="{{$module->id}}" data-bs-toggle="modal" data-bs-target="#kt_modal_update_module">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_add_module_form" class="form" action="#">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="Enter a module name" name="module_name" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="fv-row mb-7">
                                        <label class="fs-6 fw-bold form-label mb-2">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Module description is required."></i>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="Enter a module description" name="module_description" />
                                        <!--end::Input-->
                                    </div>
...
<script src="{{asset('assets/js/custom/apps/user-management/modules/modulelist.js')}}"></script>
<script src="{{asset('assets/js/custom/apps/user-management/modules/add-module.js')}}"></script>
<script src="{{asset('assets/js/custom/apps/user-management/modules/update-module.js')}}"></script>
@endpush
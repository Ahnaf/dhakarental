				...
				<div class="aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
							...
							<div class="menu-item">
								<a class="menu-link
								@if (\Request::is('admin/requestall') or \Request::is('admin/carrequestdetails/*') or \Request::is('admin/requestallhold') or \Request::is('admin/requestallconfirm') or \Request::is('admin/requestallcancel') or \Request::is('admin/requestallprocessing'))
									active
								@endif
								"
								href="{{ route('admin.requestcarlist') }}">
									<span class="menu-icon">
										<!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
										<span class="svg-icon svg-icon-2">
											<svg height="512pt" viewBox="0 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg">
												...
												<path fill="#3f4254" d="m432.734375 80.332031h-160.667969c-8.285156 0-15 6.71875-15 15 0 8.285157 6.714844 15 15 15h160.667969c8.28125 0 15-6.714843 15-15 0-8.28125-6.714844-15-15-15zm0 0"/>
												<path fill="#3f4254" d="m432.734375 144.601562h-160.667969c-8.285156 0-15 6.714844-15 15 0 8.28125 6.714844 15 15 15h160.667969c8.28125 0 15-6.71875 15-15 0-8.285156-6.714844-15-15-15zm0 0"/>
												<path fill="#3f4254" d="m352.398438 208.867188h-80.332032c-8.285156 0-15 6.714843-15 15 0 8.285156 6.714844 15 15 15h80.332032c8.285156 0 15-6.714844 15-15 0-8.285157-6.714844-15-15-15zm0 0"/>
											</svg>
										</span>
										<!--end::Svg Icon-->
									</span>
									<span class="menu-title">Request For Car</span>
								</a>
							</div>
							@endif
							...
							<div class="menu-item">
								<a class="menu-link
								@if (\Request::is('admin/carlist') or \Request::is('admin/caradd') or \Request::is('admin/cardetails/*') or \Request::is('admin/editcar/*') or \Request::is('admin/carfilter'))
									active
								@endif
								"
									...
									<span class="menu-icon">
										...
										<span class="svg-icon svg-icon-1">
											<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
												...
												fill="#3f4254" stroke="none">
												<path fill="#3f4254" d="M3525 5341 c-72 -18 -79 -28 -90 -121 -4 -30 -11 -62 -16 -71 -4 -9
												...
												256 -20z"/>
												<path fill="#3f4254" d="M2617 3125 c-431 -82 -774 -440 -838 -875 -17 -117 -7 -292 24 -410
												...
												<path fill="#3f4254" d="M2918 2568 c2 -90 7 -167 12 -172 17 -17 108 58 201 166 l51 57 -48
												31 c-52 33 -131 65 -185 75 l-34 6 3 -163z"/>
												<path fill="#3f4254" d="M2591 2700 c-62 -22 -167 -82 -164 -94 3 -13 237 -216 249 -216 7 0
												15 7 18 16 8 20 8 127 -1 232 -7 95 -8 96 -102 62z"/>
												<path fill="#3f4254" d="M3209 2355 c-57 -64 -105 -123 -107 -131 -6 -25 46 -35 157 -29 58 3
												121 8 139 11 33 5 34 6 27 42 -7 44 -64 167 -92 201 l-19 24 -105 -118z"/>
												<path fill="#3f4254" d="M2260 2409 c-31 -44 -68 -133 -77 -186 l-6 -33 155 0 c165 0 201 9
												181 44 -13 24 -204 216 -214 216 -5 0 -22 -18 -39 -41z"/>
												<path fill="#3f4254" d="M2786 2354 c-36 -35 0 -87 44 -64 26 14 26 56 1 70 -25 13 -27 13
												-45 -6z"/>
												<path fill="#3f4254" d="M2751 2186 c-57 -32 -68 -111 -22 -157 43 -42 101 -43 143 -1 42 42
												41 100 -1 143 -33 32 -78 38 -120 15z"/>
												<path fill="#3f4254" d="M2560 2136 c-19 -23 -8 -61 18 -64 44 -7 67 32 36 62 -19 20 -38 20
												-54 2z"/>
												<path fill="#3f4254" d="M3002 2124 c-27 -19 -28 -36 -3 -58 25 -23 61 -6 61 29 0 33 -30 49
												-58 29z"/>
												<path fill="#3f4254" d="M2245 1993 c-77 -6 -76 -5 -59 -65 16 -55 61 -146 92 -186 l18 -23
												103 122 c57 67 104 129 105 138 1 14 -14 16 -104 17 -58 0 -127 -1 -155 -3z"/>
												<path fill="#3f4254" d="M3165 1981 c-44 -4 -61 -10 -63 -22 -3 -16 210 -229 228 -229 22 0
												86 141 105 228 l7 32 -109 -2 c-59 -1 -135 -4 -168 -7z"/>
												<path fill="#3f4254" d="M2776 1914 c-19 -18 -19 -20 -6 -45 6 -11 21 -19 35 -19 20 0 45 24
												45 44 0 10 -32 36 -45 36 -7 0 -21 -7 -29 -16z"/>
												<path fill="#3f4254" d="M2589 1743 c-86 -90 -139 -151 -139 -162 0 -25 179 -101 236 -101
												l27 0 -7 143 c-9 166 -13 187 -35 187 -9 0 -46 -30 -82 -67z"/>
												<path fill="#3f4254" d="M2936 1801 c-6 -10 -24 -168 -29 -258 -3 -60 -2 -63 19 -63 79 0 262
												68 248 92 -5 7 -53 64 -108 126 -93 105 -117 124 -130 103z"/>
												<path fill="#3f4254" d="M10723 3125 c-318 -58 -597 -266 -743 -555 -223 -441 -98 -996 289
												...
												<path fill="#3f4254" d="M11017 2568 c3 -90 9 -167 14 -172 13 -14 53 18 155 122 l95 97 -23
												18 c-50 40 -189 97 -235 97 -10 0 -11 -33 -6 -162z"/>
												<path fill="#3f4254" d="M10705 2706 c-50 -16 -133 -58 -163 -82 l-23 -19 121 -107 c67 -60
												128 -108 135 -108 23 0 27 39 20 186 -8 162 -4 157 -90 130z"/>
												<path fill="#3f4254" d="M11307 2354 c-59 -65 -107 -126 -107 -136 0 -11 11 -18 38 -22 44 -7
												278 7 289 17 15 16 -51 183 -94 236 l-19 24 -107 -119z"/>
												<path fill="#3f4254" d="M10362 2413 c-39 -62 -70 -134 -78 -184 l-7 -39 152 0 c86 0 161 5
												...
												19 -46 5z"/>
												<path fill="#3f4254" d="M10851 2187 c-49 -29 -66 -101 -35 -146 9 -13 32 -29 50 -37 29 -12
												39 -12 68 0 99 41 85 180 -19 192 -24 3 -50 -1 -64 -9z"/>
												<path fill="#3f4254" d="M10660 2136 c-19 -23 -8 -61 18 -64 44 -7 67 32 36 62 -19 20 -38 20
												-54 2z"/>
												<path fill="#3f4254" d="M11096 2124 c-9 -8 -16 -22 -16 -29 0 -13 26 -45 36 -45 20 0 44 25
												44 45 0 14 -8 29 -19 35 -25 13 -27 13 -45 -6z"/>
												<path fill="#3f4254" d="M10335 1991 c-60 -6 -60 -6 -57 -36 9 -69 104 -248 122 -229 57 61
												210 250 207 258 -4 12 -176 17 -272 7z"/>
												<path fill="#3f4254" d="M11267 1983 c-68 -5 -79 -19 -47 -60 23 -31 200 -193 210 -193 3 0
												20 24 37 53 29 48 52 111 67 180 l6 27 -107 -2 c-60 -1 -134 -3 -166 -5z"/>
												<path fill="#3f4254" d="M10870 1910 c-16 -31 4 -62 38 -58 21 2 28 9 30 32 5 45 -47 65 -68
												26z"/>
												<path fill="#3f4254" d="M10651 1703 c-56 -59 -101 -113 -101 -120 0 -28 172 -103 237 -103
												l26 0 -7 123 c-10 179 -15 207 -36 207 -10 0 -63 -48 -119 -107z"/>
												<path fill="#3f4254" d="M11035 1801 c-7 -12 -23 -144 -29 -243 -4 -77 -4 -78 19 -78 45 0
									...
									<span class="menu-icon">
										<span class="svg-icon svg-icon-2">
											<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												...
												<g>
													<g>
														<path fill="#3f4254" d="M51.565,26.173c-0.229-2.002-5.624,0-5.624,0l-0.318,2.852c-0.119-0.066-0.236-0.129-0.363-0.188l-1.363-5.948
														...
														<circle fill="#3f4254" cx="9.3" cy="8.585" r="3.817"/>
														<path fill="#3f4254" d="M14.923,18.418l6.647,6.039v-0.003c0.004,0.006,0.005,0.011,0.011,0.011c0.629,0.627,1.65,0.627,2.279,0
							...
							<div class="menu-item">
								...
								@endif
								"
								href="{{ route('admin.invoicelist') }}">
									<span class="menu-icon">
										<span class="svg-icon svg-icon-2">
											<svg height="493pt" viewBox="0 -11 493.78 493" width="493pt" xmlns="http://www.w3.org/2000/svg">
												...
												<path fill="#3f4254" d="m192.71875 237.503906c0 4.417969 3.578125 8 8 8h106.65625c4.417969 0 8-3.582031 8-8 0-4.417968-3.582031-8-8-8h-106.65625c-4.421875 0-8 3.582032-8 8zm0 0"/>
												...
												<path fill="#3f4254" d="m307.375 299.503906h-106.65625c-4.421875 0-8 3.582032-8 8 0 4.417969 3.578125 8 8 8h106.65625c4.417969 0 8-3.582031 8-8 0-4.417968-3.582031-8-8-8zm0 0"/>
											</svg>
										</span>

    ...
    r=function(){
        t.querySelectorAll('[data-kt-subscriptions-table-filter="delete_row"]').forEach((t=>{
            t.addEventListener("click",(function(t){
                ...
                singelval = document.querySelectorAll("td")[0].getElementsByTagName('input')[0].value;
                Swal.fire({
                ...
                l=()=>{
                    ...
                    r.forEach((t=>{t.addEventListener("click",(function(){
                        ...
                        a.addEventListener("click",(function(){
                            ...
                            Swal.fire({
                                ...
                                customClass:{
                                    ...
                                    n.value ? axios('/admin/permissiondelete', {
                                        method: 'post',
                                        data: {
                                                        ...
                                                        (e=$(t).DataTable(
                                                            ...
                                                            document.querySelector('[data-kt-subscription-table-filter="search"]').addEventListener("keyup",(function(t){
                                                                ...
                                                                r(),function(){
                                                                    ...
                                                                    var t="";
                                                                    c.forEach(((e,n)=>{e.value&&""!==e.value&&(0!==n&&(t+=" "),
                                                                    t+=e.value)})),
                                                                    e.search(t).draw()})),

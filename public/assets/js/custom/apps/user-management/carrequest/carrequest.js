    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_permissions_table")) && (e.querySelectorAll("tbody tr").forEach((t => {
                ...
                document.querySelector('[data-kt-subscription-table-filter="search"]').addEventListener("keyup",
                    (function (e) {
                        t.search(e.target.value).draw()
                    })),
                e.querySelectorAll('[data-kt-subscriptions-table-filter="delete_row"]').forEach((e => {
                    e.addEventListener("click", (function (e) {
                        ...
                        Swal.fire({
                            ...
                            e.value ? axios('/admin/carrequestdelete', {
                                method: 'post',
                                data: {
                                    rcarid: o
                                }
